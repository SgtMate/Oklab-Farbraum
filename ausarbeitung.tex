...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{Grafiken/HSV_Zylinder.png}
  \includegraphics[width=0.5\textwidth]{Grafiken/HSL_Zylinder.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.3\textwidth]{Grafiken/CIELAB1.png}
  \includegraphics[width=0.3\textwidth]{Grafiken/CIELAB2.png}
  \includegraphics[width=0.3\textwidth]{Grafiken/CIELAB3.png}
